                    ...
                    <div style="display: flex; align-items: flex-start; justify-content: space-between; gap: 1rem;">
                        <div style="flex: 1; min-width: 0;">
                            ...
                            <div style="font-size: 0.8125rem; color: var(--color-text-muted); display: flex; gap: 0.85rem; flex-wrap: wrap;">
                                <span>👨‍🍳 {{ $action->dapur->nama_entitas }}</span>
                                <span>🏫 {{ $action->targetSekolah->nama_entitas }}</span>
                                <span>🔥 {{ $action->kalori }} kkal</span>
                                <span>💪 {{ $action->protein }}g protein</span>
                                <span>📦 {{ $action->porsi_rencana }} porsi</span>
                            </div>
                        </div>
