...
--
-- Host: localhost
-- Generation Time: Jun 18, 2026 at 03:42 PM
...
CREATE TABLE `kurir` (
  ...
  `bukti_pengiriman` varchar(225) NOT NULL,
...
INSERT INTO `users` (`id_users`, `password`, `role`, `nama_entitas`, `remember_token`, `created_at`, `updated_at`, `status_akun`, `username`, `email`) VALUES
...
ALTER TABLE `menus`
  ...
  ADD UNIQUE KEY `id_ahli_gizi_2` (`id_ahli_gizi`),
